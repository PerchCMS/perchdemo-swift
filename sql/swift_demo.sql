...
# Database: dbperchdemoswift
# Generation Time: 2013-06-24 11:18:20 +0000
# ************************************************************
...
VALUES
	(1,'Relocation','relocation',2,'{\"categoryTitle\":\"Relocation\",\"categorySlug\":\"relocation\"}'),
...
VALUES
	(1036,1,1,1,4,'_order','1000'),
	(1035,1,1,1,4,'_id','1'),
	(1034,1,1,1,4,'text_processed','<p><strong>Swift Migrations</strong> is an entirely fictitious company invented to demonstrate the capabilities of the Perch content management system.</p>\n\n<p>We&#8217;re really glad you stopped by. Now why not have a look around, take a peek at the sour'),
	(1033,1,1,1,4,'text_raw','*Swift Migrations* is an entirely fictitious company invented to demonstrate the capabilities of the Perch content management system.\r\n\r\nWe\'re really glad you stopped by. Now why not have a look around, take a peek at the source code and see how easy it i'),
	(1032,1,1,1,4,'text','<p><strong>Swift Migrations</strong> is an entirely fictitious company invented to demonstrate the capabilities of the Perch content management system.</p>\n\n<p>We&#8217;re really glad you stopped by. Now why not have a look around, take a peek at the sour'),
	(1001,2,2,1,5,'_order','1000'),
	(1000,2,2,1,5,'_id','2'),
	(999,2,2,1,5,'body_processed','<p>This fictional company site has been created to show you the capabilities of Perch.</p>'),
	(998,2,2,1,5,'body_raw','This fictional company site has been created to show you the capabilities of Perch.'),
	(997,2,2,1,5,'body','<p>This fictional company site has been created to show you the capabilities of Perch.</p>'),
	(996,2,2,1,5,'alt','Nesting bird'),
	(995,2,2,1,5,'image_h','520'),
	(994,2,2,1,5,'image_w','520'),
	(993,2,2,1,5,'image_bucket','default'),
	(992,2,2,1,5,'image_size','24530'),
	(991,2,2,1,5,'image_path','nesting-bird.jpg'),
	(990,2,2,1,5,'image__default','/perch/resources/nesting-bird.jpg'),
	(989,2,2,1,5,'image','/perch/resources/nesting-bird.jpg'),
	(988,2,2,1,5,'subheading','How can we help you?'),
	(987,2,2,1,5,'heading','Welcome to Swift'),
	(1016,3,3,1,3,'_order','1000'),
	(1015,3,3,1,3,'_id','3'),
	(1014,3,3,1,3,'body_processed','<p>This example shows how Perch can be added to an existing set of <span class=\"caps\">HTML</span> files &#8211; you don&#8217;t need to create a theme or change the way you work.</p>'),
	(1013,3,3,1,3,'body_raw','This example shows how Perch can be added to an existing set of HTML files - you don\'t need to create a theme or change the way you work.'),
	(1012,3,3,1,3,'body','<p>This example shows how Perch can be added to an existing set of <span class=\"caps\">HTML</span> files &#8211; you don&#8217;t need to create a theme or change the way you work.</p>'),
	(1011,3,3,1,3,'alt','Sunset'),
	(1010,3,3,1,3,'image_h','520'),
	(1009,3,3,1,3,'image_w','520'),
	(1008,3,3,1,3,'image_bucket','default'),
	(1007,3,3,1,3,'image_size','10125'),
	(1006,3,3,1,3,'image_path','sunset-birds.jpg'),
	(1005,3,3,1,3,'image__default','/perch/resources/sunset-birds.jpg'),
	(1004,3,3,1,3,'image','/perch/resources/sunset-birds.jpg'),
	(1003,3,3,1,3,'subheading','Retrofit an existing site'),
	(1002,3,3,1,3,'heading','Simple to install'),
	(1031,4,4,1,5,'_order','1000'),
	(1030,4,4,1,5,'_id','4'),
	(1029,4,4,1,5,'body_processed','<p>Once you start to use Perch you&#8217;ll discover it is far more capable than a simple content editor. Dive into our <a href=\"http://docs.grabaperch.com\">documentation</a> and <a href=\"http://docs.grabaperch.com/video\">video tutorial</a> for more.</p>'),
	(1028,4,4,1,5,'body_raw','Once you start to use Perch you\'ll discover it is far more capable than a simple content editor. Dive into our \"documentation\":http://docs.grabaperch.com and \"video tutorial\":http://docs.grabaperch.com/video for more.'),
	(1027,4,4,1,5,'body','<p>Once you start to use Perch you&#8217;ll discover it is far more capable than a simple content editor. Dive into our <a href=\"http://docs.grabaperch.com\">documentation</a> and <a href=\"http://docs.grabaperch.com/video\">video tutorial</a> for more.</p>'),
	(1026,4,4,1,5,'alt','Bird house'),
	(1025,4,4,1,5,'image_h','520'),
	(1024,4,4,1,5,'image_w','520'),
	(1023,4,4,1,5,'image_bucket','default'),
	(1022,4,4,1,5,'image_size','24066'),
	(1021,4,4,1,5,'image_path','birdhouse.jpg'),
	(1020,4,4,1,5,'image__default','/perch/resources/birdhouse.jpg'),
	(1019,4,4,1,5,'image','/perch/resources/birdhouse.jpg'),
	(1018,4,4,1,5,'subheading','Perch can be powerful'),
	(1042,5,5,2,2,'_order','1000'),
	(1041,5,5,2,2,'_id','5'),
	(1040,5,5,2,2,'body_processed','<p>Here we can add some content to give the visitor a taste of what is on this page.</p>'),
	(1039,5,5,2,2,'body_raw','Here we can add some content to give the visitor a taste of what is on this page.'),
	(1038,5,5,2,2,'body','<p>Here we can add some content to give the visitor a taste of what is on this page.</p>'),
	(1037,5,5,2,2,'heading','All about Swift Migrations'),
	(1047,6,6,2,2,'_order','1000'),
	(1046,6,6,2,2,'_id','6'),
	(1045,6,6,2,2,'text_processed','<h2>About Swift Migrations</h2>\n\n<p>This is a straightforward text block. It’s formatted using the Textile formatting language, although Markdown is an available alternative. You can also install one of many <span class=\"caps\">WYSIWYG</span> editors –'),
	(1044,6,6,2,2,'text_raw','h2. About Swift Migrations\r\n\r\nThis is a straightforward text block. It’s formatted using the Textile formatting language, although Markdown is an available alternative. You can also install one of many WYSIWYG editors – we have TinyMCE and CKEditor av'),
	(1043,6,6,2,2,'text','<h2>About Swift Migrations</h2>\n\n<p>This is a straightforward text block. It’s formatted using the Textile formatting language, although Markdown is an available alternative. You can also install one of many <span class=\"caps\">WYSIWYG</span> editors –'),
	(1053,7,7,3,2,'_order','1000'),
	(1052,7,7,3,2,'_id','7'),
	(1051,7,7,3,2,'body_processed','<p>Moving flocks for the last 80 years.</p>'),
	(1050,7,7,3,2,'body_raw','Moving flocks for the last 80 years.'),
	(1049,7,7,3,2,'body','<p>Moving flocks for the last 80 years.</p>'),
	(1048,7,7,3,2,'heading','Our History'),
	(1058,8,8,3,2,'_order','1000'),
	(1057,8,8,3,2,'_id','8'),
	(1056,8,8,3,2,'text_processed','<h2>Our History</h2>\n\n<p>This is a straightforward text block. It’s formatted using the Textile formatting language, although Markdown is an available alternative. You can also install one of many <span class=\"caps\">WYSIWYG</span> editors – we have Ti'),
	(1055,8,8,3,2,'text_raw','h2. Our History\r\n\r\nThis is a straightforward text block. It’s formatted using the Textile formatting language, although Markdown is an available alternative. You can also install one of many WYSIWYG editors – we have TinyMCE and CKEditor available as'),
	(1054,8,8,3,2,'text','<h2>Our History</h2>\n\n<p>This is a straightforward text block. It’s formatted using the Textile formatting language, although Markdown is an available alternative. You can also install one of many <span class=\"caps\">WYSIWYG</span> editors – we have Ti'),
	(787,9,9,4,2,'_order','1000'),
	(786,9,9,4,2,'_id','9'),
	(785,9,9,4,2,'phone','123 45678'),
	(784,9,9,4,2,'email','madeup@example.com'),
	(783,9,9,4,2,'country','United Kingdom'),
	(782,9,9,4,2,'postcode','NE1 4TV'),
	(781,9,9,4,2,'locality','Smalltown'),
	(780,9,9,4,2,'address2','123 Letsbe Avenue'),
	(779,9,9,4,2,'address1','The Old Church'),
	(778,9,9,4,2,'company','Swift Migrations'),
	(1078,10,10,4,4,'_order','1000'),
	(1077,10,10,4,4,'_id','10'),
	(1076,10,10,4,4,'map_html','<img id=\"cmsmap98-1\" src=\"http://maps.google.com/maps/api/staticmap?center=51.483224348017366,-0.6048382767212379&amp;sensor=false&amp;size=560x300&amp;zoom=15&amp;maptype=map&amp;markers=color:red|color:red|51.4838123,-0.6046237000000474\"  width=\"560\" he'),
	(1075,10,10,4,4,'map_admin_html','<img id=\"cmsmap98-1\" src=\"http://maps.google.com/maps/api/staticmap?center=51.483224348017366,-0.6048382767212379&amp;sensor=false&amp;size=560x300&amp;zoom=15&amp;maptype=map&amp;markers=color:red|color:red|51.4838123,-0.6046237000000474\"  width=\"560\" he'),
	(1074,10,10,4,4,'map_type','map'),
	(1073,10,10,4,4,'map_zoom','15'),
	(1072,10,10,4,4,'map_clng','-0.6048382767212379'),
	(1071,10,10,4,4,'map_clat','51.483224348017366'),
	(1070,10,10,4,4,'map_lng','-0.6046237000000474'),
	(1069,10,10,4,4,'map_lat','51.4838123'),
	(1068,10,10,4,4,'map__default','Windsor Castle, Windsor'),
	(1067,10,10,4,4,'map__title','Windsor Castle, Windsor'),
	(1066,10,10,4,4,'map_adr','Windsor Castle, Windsor'),
	(1065,10,10,4,4,'map','Windsor Castle, Windsor'),
	(1064,11,11,4,7,'_order','1000'),
	(1063,11,11,4,7,'_id','11'),
	(1062,11,11,4,7,'success_processed','<p>Thank you for submitting our form. We will be in touch soon!</p>'),
	(1061,11,11,4,7,'success_raw','Thank you for submitting our form. We will be in touch soon!'),
	(1060,11,11,4,7,'success','<p>Thank you for submitting our form. We will be in touch soon!</p>'),
	(1059,11,11,4,7,'heading','Contact us swiftly using this form'),
	(1084,12,12,5,2,'_order','1000'),
	(1083,12,12,5,2,'_id','12'),
	(1082,12,12,5,2,'body_processed','<p>Our team are based in locations around the world. Some migrate mid-year to better serve seasonal locations.</p>'),
	(1081,12,12,5,2,'body_raw','Our team are based in locations around the world. Some migrate mid-year to better serve seasonal locations.'),
	(1080,12,12,5,2,'body','<p>Our team are based in locations around the world. Some migrate mid-year to better serve seasonal locations.</p>'),
	(1079,12,12,5,2,'heading','The Team'),
	(1252,22,13,5,11,'_order','1003'),
	(1251,22,13,5,11,'_id','22'),
	(1250,22,13,5,11,'bio_processed','<p>You’re just another wise person giving the Perch demo a quick try. We thank you for your interest. If you have any questions, just <a href=\"mailto:hello@grabaperch.com\">drop us a line!</a></p>'),
	(1249,22,13,5,11,'bio_raw','You’re just another wise person giving the Perch demo a quick try. We thank you for your interest. If you have any questions, just \"drop us a line!\":mailto:hello@grabaperch.com'),
	(1248,22,13,5,11,'bio','<p>You’re just another wise person giving the Perch demo a quick try. We thank you for your interest. If you have any questions, just <a href=\"mailto:hello@grabaperch.com\">drop us a line!</a></p>'),
	(1247,22,13,5,11,'image_h','400'),
	(1246,22,13,5,11,'image_w','400'),
	(1245,22,13,5,11,'image_bucket','default'),
	(1244,22,13,5,11,'image_size','13365'),
	(1243,22,13,5,11,'image_path','bird-4.jpg'),
	(1242,22,13,5,11,'image__default','/perch/resources/bird-4.jpg'),
	(1241,22,13,5,11,'image','/perch/resources/bird-4.jpg'),
	(1240,22,13,5,11,'role','That\'s you!'),
	(1239,22,13,5,11,'familyname','{lastname}'),
	(1238,22,13,5,11,'givenname','{firstname}'),
	(1237,21,13,5,11,'_order','1002'),
	(1236,21,13,5,11,'_id','21'),
	(1235,21,13,5,11,'bio_processed','<p>This person was only employed to demonstrate how additional list items will stack up. That may seem a little extravagant, but that’s how we roll at Swift Migrations.</p>'),
	(1234,21,13,5,11,'bio_raw','This person was only employed to demonstrate how additional list items will stack up. That may seem a little extravagant, but that’s how we roll at Swift Migrations.'),
	(1233,21,13,5,11,'bio','<p>This person was only employed to demonstrate how additional list items will stack up. That may seem a little extravagant, but that’s how we roll at Swift Migrations.</p>'),
	(1232,21,13,5,11,'image_h','400'),
	(1231,21,13,5,11,'image_w','400'),
	(1230,21,13,5,11,'image_bucket','default'),
	(1229,21,13,5,11,'image_size','26442'),
	(1228,21,13,5,11,'image_path','bird-3.jpg'),
	(1227,21,13,5,11,'image__default','/perch/resources/bird-3.jpg'),
	(1226,21,13,5,11,'image','/perch/resources/bird-3.jpg'),
	(1225,21,13,5,11,'role','Web Developer'),
	(1224,21,13,5,11,'familyname','Bloggs'),
	(1223,21,13,5,11,'givenname','Joe'),
	...
	(1150,17,16,6,2,'_order','1000'),
	(1149,17,16,6,2,'_id','17'),
	(1148,17,16,6,2,'body_processed','<p>People say some lovely things.</p>'),
	(1147,17,16,6,2,'body_raw','People say some lovely things.'),
	(1146,17,16,6,2,'body','<p>People say some lovely things.</p>'),
	(1145,17,16,6,2,'heading','Testimonials'),
	(1174,20,17,6,4,'_order','1002'),
	(1173,20,17,6,4,'_id','20'),
	(1172,20,17,6,4,'quote_processed','<p>Swift Migrations moved our whole flock quickly and without fuss. We were also very happy with the bill!</p>'),
	(1171,20,17,6,4,'quote_raw','Swift Migrations moved our whole flock quickly and without fuss. We were also very happy with the bill!'),
	(1170,20,17,6,4,'quote','<p>Swift Migrations moved our whole flock quickly and without fuss. We were also very happy with the bill!</p>'),
	(1169,20,17,6,4,'role','Swan and Co'),
	(1168,20,17,6,4,'familyname','Customer'),
	(1167,20,17,6,4,'givenname','C'),
	(1166,19,17,6,4,'_order','1001'),
	(1165,19,17,6,4,'_id','19'),
	(1164,19,17,6,4,'quote_processed','<p>Our company were looking at expanding into warmer climates for the winter. Swift Migrations made the move effortless.</p>'),
	(1163,19,17,6,4,'quote_raw','Our company were looking at expanding into warmer climates for the winter. Swift Migrations made the move effortless.'),
	(1162,19,17,6,4,'quote','<p>Our company were looking at expanding into warmer climates for the winter. Swift Migrations made the move effortless.</p>'),
	(1161,19,17,6,4,'role','Robin International'),
	(1160,19,17,6,4,'familyname','Customer'),
	(1159,19,17,6,4,'givenname','B'),
	(1158,18,17,6,4,'_order','1000'),
	(1157,18,17,6,4,'_id','18'),
	(1156,18,17,6,4,'quote_processed','<p>Swift Migrations got me settled into my new nest very quickly. I don&#8217;t know what I&#8217;d have done without them.</p>'),
	(1155,18,17,6,4,'quote_raw','Swift Migrations got me settled into my new nest very quickly. I don\'t know what I\'d have done without them.'),
	(1154,18,17,6,4,'quote','<p>Swift Migrations got me settled into my new nest very quickly. I don&#8217;t know what I&#8217;d have done without them.</p>'),
	(1153,18,17,6,4,'role','Mallard Industries'),
	(1152,18,17,6,4,'familyname','Customer'),
	(1151,18,17,6,4,'givenname','A'),
	(1222,14,13,5,11,'_order','1001'),
	(1221,14,13,5,11,'_id','14'),
	(1220,14,13,5,11,'bio_processed','<p>Drew McLellan joined edgeofmyseat.com as a Director and web developer in September 2007. He’s the lead developer on Perch.</p>'),
	(1219,14,13,5,11,'bio_raw','Drew McLellan joined edgeofmyseat.com as a Director and web developer in September 2007. He’s the lead developer on Perch.'),
	(1218,14,13,5,11,'bio','<p>Drew McLellan joined edgeofmyseat.com as a Director and web developer in September 2007. He’s the lead developer on Perch.</p>'),
	(1217,14,13,5,11,'image_h','400'),
	(1216,14,13,5,11,'image_w','400'),
	(1215,14,13,5,11,'image_bucket','default'),
	(1214,14,13,5,11,'image_size','14768'),
	(1213,14,13,5,11,'image_path','bird-2.jpg'),
	(1212,14,13,5,11,'image__default','/perch/resources/bird-2.jpg'),
	(1211,14,13,5,11,'image','/perch/resources/bird-2.jpg'),
	(1210,14,13,5,11,'role','Company Director'),
	(1209,14,13,5,11,'familyname','McLellan'),
	(1208,14,13,5,11,'givenname','Drew'),
	(1207,13,13,5,11,'_order','1000'),
	(1206,13,13,5,11,'_id','13'),
	(1205,13,13,5,11,'bio_processed','<p>Rachel Andrew founded edgeofmyseat.com in September 2001 and is an experienced front and back-end web developer.</p>'),
	(1204,13,13,5,11,'bio_raw','Rachel Andrew founded edgeofmyseat.com in September 2001 and is an experienced front and back-end web developer.'),
	(1203,13,13,5,11,'bio','<p>Rachel Andrew founded edgeofmyseat.com in September 2001 and is an experienced front and back-end web developer.</p>'),
	(1202,13,13,5,11,'image_h','400'),
	(1201,13,13,5,11,'image_w','400'),
	(1200,13,13,5,11,'image_bucket','default'),
	(1199,13,13,5,11,'image_size','16138'),
	(1198,13,13,5,11,'image_path','bird-1.jpg'),
	(1197,13,13,5,11,'image__default','/perch/resources/bird-1.jpg'),
	(1196,13,13,5,11,'image','/perch/resources/bird-1.jpg'),
	(1195,13,13,5,11,'role','Company Director & Founder'),
	(1194,13,13,5,11,'familyname','Andrew'),
	(1193,13,13,5,11,'givenname','Rachel'),
	(1180,23,18,7,2,'_order','1000'),
	(1179,23,18,7,2,'_id','23'),
	(1178,23,18,7,2,'body_processed','<p>Read the latest news and relocation tips from Swift Migrations.</p>'),
	(1177,23,18,7,2,'body_raw','Read the latest news and relocation tips from Swift Migrations.'),
	(1176,23,18,7,2,'body','<p>Read the latest news and relocation tips from Swift Migrations.</p>'),
	(1175,23,18,7,2,'heading','Our Blog'),
	(1186,24,19,8,2,'_order','1000'),
	(1185,24,19,8,2,'_id','24'),
	(1184,24,19,8,2,'body_processed','<p>We were founded in the year 2009 after an accident involving a walrus.</p>'),
	(1183,24,19,8,2,'body_raw','We were founded in the year 2009 after an accident involving a walrus.'),
	(1182,24,19,8,2,'body','<p>We were founded in the year 2009 after an accident involving a walrus.</p>'),
	(1181,24,19,8,2,'heading','Did you know?'),
	(1192,25,20,9,2,'_order','1000'),
	(1191,25,20,9,2,'_id','25'),
	(1190,25,20,9,2,'body_processed','<p>All of the posts can be found here.</p>'),
	(1189,25,20,9,2,'body_raw','All of the posts can be found here.'),
	(1188,25,20,9,2,'body','<p>All of the posts can be found here.</p>'),
	(1187,25,20,9,2,'heading','Blog Archive'),
	(1017,4,4,1,5,'heading','More than you might think');
...
VALUES
	(1,1,'Intro','/index.php','<p><strong>Swift Migrations</strong> is an entirely fictitious company invented to demonstrate the capabilities of the Perch content management system.</p>\n\n<p>We&#8217;re really glad you stopped by. Now why not have a look around, take a peek at the source code and see how easy it is to get Perch up and running for your next project.</p>\n\n	<ul>\n		<li><a href=\"https://github.com/PerchCMS/perchdemo-swift\">The Source Code for the site is available on GitHub</a></li>\n		<li><a href=\"http://docs.grabaperch.com/video\">The video tutorial demonstrates how this site was developed</a></li>\n	</ul>',0,3,'text_block.html',0,'{\"edit_mode\":\"singlepage\"}',1,4,4,'*'),
...
VALUES
	(1,'form-contact','Form contact','/templates/content/contactform.html','{\"store\":true}');
...
VALUES
	(1,0,'/index.php','Home page','Home page',0,1,1,'','000-001','','',0,0,''),
	(2,0,'/about/index.php','About','About',0,2,1,'/about','000-002','','',0,0,''),
	(3,2,'/about/history.php','History','History',0,1,2,'/about/history','000-002-001','','',0,0,''),
	(4,0,'/contact.php','Contact','Contact',0,3,1,'/contact','000-003','','',0,0,''),
	(5,0,'/team.php','Team','Team',0,4,1,'/team','000-004','','',0,0,''),
	(6,0,'/testimonials.php','Testimonials','Testimonials',0,5,1,'/testimonials','000-005','','',0,0,''),
	(7,0,'/blog/index.php','Blog','Blog',0,6,1,'/blog','000-006','','',0,0,''),
	(8,7,'/blog/post.php','Post','Post',0,1,2,'/blog/post','000-006-001','','',0,0,''),
	(9,7,'/blog/archive.php','Archive','Archive',0,2,2,'/blog/archive','000-006-002','','',0,0,'');
...
VALUES
	(1,'content','default','nesting-bird.jpg','orig',0,'jpg'),
...
VALUES
	(1,'{username}','{password}','2013-05-02 12:55:56','2013-06-24 12:15:49','2013-06-24 11:14:45','{firstname}','{lastname}','{email}',1,'c7b5ea1a56b09c2efa55420346eaea16',2,1);
