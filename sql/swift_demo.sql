...
--
-- Host: localhost    Database: dbPerchDemoSwift
-- ------------------------------------------------------
...
INSERT INTO `perch2_blog_categories` VALUES (1,'Relocation','relocation',2,'{\"categoryTitle\":\"Relocation\",\"categorySlug\":\"relocation\"}'),
	(2,'Immigration','immigration',0,'{\"categoryTitle\":\"Immigration\",\"categorySlug\":\"immigration\"}'),
	(3,'Employees','employees',1,'{\"categoryTitle\":\"Employees\",\"categorySlug\":\"employees\"}'),
	(4,'Business','business',2,'{\"categoryTitle\":\"Business\",\"categorySlug\":\"business\"}'),
	(5,'Really big business','really-big-business',0,'{\"categoryTitle\":\"Really big business\",\"categorySlug\":\"really-big-business\"}');
...
INSERT INTO `perch2_blog_posts_to_tags` VALUES (1,1),
	(1,2),
	(2,3),
	(2,4);
...
INSERT INTO `perch2_blog_tags` VALUES (1,'flying','flying'),
	(2,'fear','fear'),
	(3,'young people','young-people'),
...
INSERT INTO `perch2_content_index` VALUES (1900,1,1,1,4,'_order','1000'),
	(1899,1,1,1,4,'_id','1'),
	(1898,1,1,1,4,'text_processed','<p><strong>Swift Migrations</strong> is an entirely fictitious company invented to demonstrate the capabilities of the Perch content management system.</p>\n\n<p>We&#8217;re really glad you stopped by. Now why not have a look around, take a peek at the sour'),
	(1897,1,1,1,4,'text_raw','*Swift Migrations* is an entirely fictitious company invented to demonstrate the capabilities of the Perch content management system.\r\n\r\nWe\'re really glad you stopped by. Now why not have a look around, take a peek at the source code and see how easy it i'),
	(1896,1,1,1,4,'text','<p><strong>Swift Migrations</strong> is an entirely fictitious company invented to demonstrate the capabilities of the Perch content management system.</p>\n\n<p>We&#8217;re really glad you stopped by. Now why not have a look around, take a peek at the sour'),
	(1699,2,2,1,5,'_order','1000'),
	(1698,2,2,1,5,'_id','2'),
	(1697,2,2,1,5,'body_processed','<p>This fictional company site has been created to show you the capabilities of Perch.</p>'),
	(1696,2,2,1,5,'body_raw','This fictional company site has been created to show you the capabilities of Perch.'),
	(1695,2,2,1,5,'body','<p>This fictional company site has been created to show you the capabilities of Perch.</p>'),
	(1694,2,2,1,5,'alt','Nesting bird'),
	(1693,2,2,1,5,'image_h','520'),
	(1692,2,2,1,5,'image_w','520'),
	(1691,2,2,1,5,'image_bucket','default'),
	(1690,2,2,1,5,'image_size','24530'),
	(1689,2,2,1,5,'image_path','nesting-bird.jpg'),
	(1688,2,2,1,5,'image__default','/perch/resources/nesting-bird.jpg'),
	(1687,2,2,1,5,'image','/perch/resources/nesting-bird.jpg'),
	(1686,2,2,1,5,'subheading','How can we help you?'),
	(1685,2,2,1,5,'heading','Welcome to Swift'),
	(1772,3,3,1,3,'_order','1000'),
	(1771,3,3,1,3,'_id','3'),
	(1770,3,3,1,3,'body_processed','<p>This example shows how Perch can be added to an existing set of <span class=\"caps\">HTML</span> files &#8211; you don&#8217;t need to create a theme or change the way you work.</p>'),
	(1769,3,3,1,3,'body_raw','This example shows how Perch can be added to an existing set of HTML files - you don\'t need to create a theme or change the way you work.'),
	(1768,3,3,1,3,'body','<p>This example shows how Perch can be added to an existing set of <span class=\"caps\">HTML</span> files &#8211; you don&#8217;t need to create a theme or change the way you work.</p>'),
	(1767,3,3,1,3,'alt','Sunset'),
	(1766,3,3,1,3,'image_h','520'),
	(1765,3,3,1,3,'image_w','520'),
	(1764,3,3,1,3,'image_bucket','default'),
	(1763,3,3,1,3,'image_size','10125'),
	(1762,3,3,1,3,'image_path','sunset-birds.jpg'),
	(1761,3,3,1,3,'image__default','/perch/resources/sunset-birds.jpg'),
	(1760,3,3,1,3,'image','/perch/resources/sunset-birds.jpg'),
	(1759,3,3,1,3,'subheading','Retrofit an existing site'),
	(1758,3,3,1,3,'heading','Simple to install'),
	(1881,4,4,1,5,'_order','1000'),
	(1880,4,4,1,5,'_id','4'),
	(1879,4,4,1,5,'body_processed','<p>Once you start to use Perch you&#8217;ll discover it is far more capable than a simple content editor. Dive into our <a href=\"http://docs.grabaperch.com\">documentation</a> and <a href=\"http://docs.grabaperch.com/video\">video tutorial</a> for more.</p>'),
	(1878,4,4,1,5,'body_raw','Once you start to use Perch you\'ll discover it is far more capable than a simple content editor. Dive into our \"documentation\":http://docs.grabaperch.com and \"video tutorial\":http://docs.grabaperch.com/video for more.'),
	(1877,4,4,1,5,'body','<p>Once you start to use Perch you&#8217;ll discover it is far more capable than a simple content editor. Dive into our <a href=\"http://docs.grabaperch.com\">documentation</a> and <a href=\"http://docs.grabaperch.com/video\">video tutorial</a> for more.</p>'),
	(1876,4,4,1,5,'alt','Bird house'),
	(1875,4,4,1,5,'image_h','520'),
	(1874,4,4,1,5,'image_w','520'),
	(1873,4,4,1,5,'image_bucket','default'),
	(1872,4,4,1,5,'image_size','24066'),
	(1871,4,4,1,5,'image_path','birdhouse.jpg'),
	(1870,4,4,1,5,'image__default','/perch/resources/birdhouse.jpg'),
	(1869,4,4,1,5,'image','/perch/resources/birdhouse.jpg'),
	(1868,4,4,1,5,'subheading','Perch can be powerful'),
	(1705,5,5,2,2,'_order','1000'),
	(1704,5,5,2,2,'_id','5'),
	(1703,5,5,2,2,'body_processed','<p>Here we can add some content to give the visitor a taste of what is on this page.</p>'),
	(1702,5,5,2,2,'body_raw','Here we can add some content to give the visitor a taste of what is on this page.'),
	(1701,5,5,2,2,'body','<p>Here we can add some content to give the visitor a taste of what is on this page.</p>'),
	(1700,5,5,2,2,'heading','All about Swift Migrations'),
	(1777,6,6,2,2,'_order','1000'),
	(1776,6,6,2,2,'_id','6'),
	(1775,6,6,2,2,'text_processed','<h2>About Swift Migrations</h2>\n\n<p>This is a straightforward text block. It’s formatted using the Textile formatting language, although Markdown is an available alternative. You can also install one of many <span class=\"caps\">WYSIWYG</span> editors –'),
	(1774,6,6,2,2,'text_raw','h2. About Swift Migrations\r\n\r\nThis is a straightforward text block. It’s formatted using the Textile formatting language, although Markdown is an available alternative. You can also install one of many WYSIWYG editors – we have TinyMCE and CKEditor av'),
	(1773,6,6,2,2,'text','<h2>About Swift Migrations</h2>\n\n<p>This is a straightforward text block. It’s formatted using the Textile formatting language, although Markdown is an available alternative. You can also install one of many <span class=\"caps\">WYSIWYG</span> editors –'),
	(1711,7,7,3,2,'_order','1000'),
	(1710,7,7,3,2,'_id','7'),
	(1709,7,7,3,2,'body_processed','<p>Moving flocks for the last 80 years.</p>'),
	(1708,7,7,3,2,'body_raw','Moving flocks for the last 80 years.'),
	(1707,7,7,3,2,'body','<p>Moving flocks for the last 80 years.</p>'),
	(1706,7,7,3,2,'heading','Our History'),
	(1782,8,8,3,2,'_order','1000'),
	(1781,8,8,3,2,'_id','8'),
	(1780,8,8,3,2,'text_processed','<h2>Our History</h2>\n\n<p>This is a straightforward text block. It’s formatted using the Textile formatting language, although Markdown is an available alternative. You can also install one of many <span class=\"caps\">WYSIWYG</span> editors – we have Ti'),
	(1779,8,8,3,2,'text_raw','h2. Our History\r\n\r\nThis is a straightforward text block. It’s formatted using the Textile formatting language, although Markdown is an available alternative. You can also install one of many WYSIWYG editors – we have TinyMCE and CKEditor available as'),
	(1778,8,8,3,2,'text','<h2>Our History</h2>\n\n<p>This is a straightforward text block. It’s formatted using the Textile formatting language, although Markdown is an available alternative. You can also install one of many <span class=\"caps\">WYSIWYG</span> editors – we have Ti'),
	(1721,9,9,4,2,'_order','1000'),
	(1720,9,9,4,2,'_id','9'),
	(1719,9,9,4,2,'phone','123 45678'),
	(1718,9,9,4,2,'email','madeup@example.com'),
	(1717,9,9,4,2,'country','United Kingdom'),
	(1716,9,9,4,2,'postcode','NE1 4TV'),
	(1715,9,9,4,2,'locality','Smalltown'),
	(1714,9,9,4,2,'address2','123 Letsbe Avenue'),
	(1713,9,9,4,2,'address1','The Old Church'),
	(1712,9,9,4,2,'company','Swift Migrations'),
	(1895,10,10,4,4,'_order','1000'),
	(1894,10,10,4,4,'_id','10'),
	(1893,10,10,4,4,'map_html','<img id=\"cmsmap98-1\" src=\"http://maps.google.com/maps/api/staticmap?center=51.483224348017366,-0.6048382767212379&amp;sensor=false&amp;size=560x300&amp;zoom=15&amp;maptype=map&amp;markers=color:red|color:red|51.4838123,-0.6046237000000474\"  width=\"560\" he'),
	(1892,10,10,4,4,'map_admin_html','<img id=\"cmsmap98-1\" src=\"http://maps.google.com/maps/api/staticmap?center=51.483224348017366,-0.6048382767212379&amp;sensor=false&amp;size=560x300&amp;zoom=15&amp;maptype=map&amp;markers=color:red|color:red|51.4838123,-0.6046237000000474\"  width=\"560\" he'),
	(1891,10,10,4,4,'map_type','map'),
	(1890,10,10,4,4,'map_zoom','15'),
	(1889,10,10,4,4,'map_clng','-0.6048382767212379'),
	(1888,10,10,4,4,'map_clat','51.483224348017366'),
	(1887,10,10,4,4,'map_lng','-0.6046237000000474'),
	(1886,10,10,4,4,'map_lat','51.4838123'),
	(1885,10,10,4,4,'map__default','Windsor Castle, Windsor'),
	(1884,10,10,4,4,'map__title','Windsor Castle, Windsor'),
	(1883,10,10,4,4,'map_adr','Windsor Castle, Windsor'),
	(1882,10,10,4,4,'map','Windsor Castle, Windsor'),
	(1727,11,11,4,7,'_order','1000'),
	(1726,11,11,4,7,'_id','11'),
	(1725,11,11,4,7,'success_processed','<p>Thank you for submitting our form. We will be in touch soon!</p>'),
	(1724,11,11,4,7,'success_raw','Thank you for submitting our form. We will be in touch soon!'),
	(1723,11,11,4,7,'success','<p>Thank you for submitting our form. We will be in touch soon!</p>'),
	(1722,11,11,4,7,'heading','Contact us swiftly using this form'),
	(1733,12,12,5,2,'_order','1000'),
	(1732,12,12,5,2,'_id','12'),
	(1731,12,12,5,2,'body_processed','<p>Our team are based in locations around the world. Some migrate mid-year to better serve seasonal locations.</p>'),
	(1730,12,12,5,2,'body_raw','Our team are based in locations around the world. Some migrate mid-year to better serve seasonal locations.'),
	(1729,12,12,5,2,'body','<p>Our team are based in locations around the world. Some migrate mid-year to better serve seasonal locations.</p>'),
	(1728,12,12,5,2,'heading','The Team'),
	(1842,22,13,5,11,'_order','1003'),
	(1841,22,13,5,11,'_id','22'),
	(1840,22,13,5,11,'bio_processed','<p>You’re just another wise person giving the Perch demo a quick try. We thank you for your interest. If you have any questions, just <a href=\"mailto:hello@grabaperch.com\">drop us a line!</a></p>'),
	(1839,22,13,5,11,'bio_raw','You’re just another wise person giving the Perch demo a quick try. We thank you for your interest. If you have any questions, just \"drop us a line!\":mailto:hello@grabaperch.com'),
	(1838,22,13,5,11,'bio','<p>You’re just another wise person giving the Perch demo a quick try. We thank you for your interest. If you have any questions, just <a href=\"mailto:hello@grabaperch.com\">drop us a line!</a></p>'),
	(1837,22,13,5,11,'image_h','400'),
	(1836,22,13,5,11,'image_w','400'),
	(1835,22,13,5,11,'image_bucket','default'),
	(1834,22,13,5,11,'image_size','13365'),
	(1833,22,13,5,11,'image_path','bird-4.jpg'),
	(1832,22,13,5,11,'image__default','/perch/resources/bird-4.jpg'),
	(1831,22,13,5,11,'image','/perch/resources/bird-4.jpg'),
	(1830,22,13,5,11,'role','That\'s you!'),
	(1829,22,13,5,11,'familyname','{lastname}'),
	(1828,22,13,5,11,'givenname','{firstname}'),
	(1827,21,13,5,11,'_order','1002'),
	(1826,21,13,5,11,'_id','21'),
	(1825,21,13,5,11,'bio_processed','<p>This person was only employed to demonstrate how additional list items will stack up. That may seem a little extravagant, but that’s how we roll at Swift Migrations.</p>'),
	(1824,21,13,5,11,'bio_raw','This person was only employed to demonstrate how additional list items will stack up. That may seem a little extravagant, but that’s how we roll at Swift Migrations.'),
	(1823,21,13,5,11,'bio','<p>This person was only employed to demonstrate how additional list items will stack up. That may seem a little extravagant, but that’s how we roll at Swift Migrations.</p>'),
	(1822,21,13,5,11,'image_h','400'),
	(1821,21,13,5,11,'image_w','400'),
	(1820,21,13,5,11,'image_bucket','default'),
	(1819,21,13,5,11,'image_size','26442'),
	(1818,21,13,5,11,'image_path','bird-3.jpg'),
	(1817,21,13,5,11,'image__default','/perch/resources/bird-3.jpg'),
	(1816,21,13,5,11,'image','/perch/resources/bird-3.jpg'),
	(1815,21,13,5,11,'role','Web Developer'),
	(1814,21,13,5,11,'familyname','Bloggs'),
	(1813,21,13,5,11,'givenname','Joe'),
	(451,15,14,6,1,'text','Testimonials'),
	(452,15,14,6,1,'_id','15'),
	(453,15,14,6,1,'_order','1000'),
	(454,16,15,6,1,'text','<p>People say some lovely things.</p>'),
	(455,16,15,6,1,'text_raw','People say some lovely things.'),
	(456,16,15,6,1,'text_processed','<p>People say some lovely things.</p>'),
	(457,16,15,6,1,'_id','16'),
	(458,16,15,6,1,'_order','1000'),
	(1739,17,16,6,2,'_order','1000'),
	(1738,17,16,6,2,'_id','17'),
	(1737,17,16,6,2,'body_processed','<p>People say some lovely things.</p>'),
	(1736,17,16,6,2,'body_raw','People say some lovely things.'),
	(1735,17,16,6,2,'body','<p>People say some lovely things.</p>'),
	(1734,17,16,6,2,'heading','Testimonials'),
	(1866,20,17,6,4,'_order','1002'),
	(1865,20,17,6,4,'_id','20'),
	(1864,20,17,6,4,'quote_processed','<p>Swift Migrations moved our whole flock quickly and without fuss. We were also very happy with the bill!</p>'),
	(1863,20,17,6,4,'quote_raw','Swift Migrations moved our whole flock quickly and without fuss. We were also very happy with the bill!'),
	(1862,20,17,6,4,'quote','<p>Swift Migrations moved our whole flock quickly and without fuss. We were also very happy with the bill!</p>'),
	(1861,20,17,6,4,'role','Swan and Co'),
	(1860,20,17,6,4,'familyname','Customer'),
	(1859,20,17,6,4,'givenname','C'),
	(1858,19,17,6,4,'_order','1001'),
	(1857,19,17,6,4,'_id','19'),
	(1856,19,17,6,4,'quote_processed','<p>Our company were looking at expanding into warmer climates for the winter. Swift Migrations made the move effortless.</p>'),
	(1855,19,17,6,4,'quote_raw','Our company were looking at expanding into warmer climates for the winter. Swift Migrations made the move effortless.'),
	(1854,19,17,6,4,'quote','<p>Our company were looking at expanding into warmer climates for the winter. Swift Migrations made the move effortless.</p>'),
	(1853,19,17,6,4,'role','Robin International'),
	(1852,19,17,6,4,'familyname','Customer'),
	(1851,19,17,6,4,'givenname','B'),
	(1850,18,17,6,4,'_order','1000'),
	(1849,18,17,6,4,'_id','18'),
	(1848,18,17,6,4,'quote_processed','<p>Swift Migrations got me settled into my new nest very quickly. I don&#8217;t know what I&#8217;d have done without them.</p>'),
	(1847,18,17,6,4,'quote_raw','Swift Migrations got me settled into my new nest very quickly. I don\'t know what I\'d have done without them.'),
	(1846,18,17,6,4,'quote','<p>Swift Migrations got me settled into my new nest very quickly. I don&#8217;t know what I&#8217;d have done without them.</p>'),
	(1845,18,17,6,4,'role','Mallard Industries'),
	(1844,18,17,6,4,'familyname','Customer'),
	(1843,18,17,6,4,'givenname','A'),
	(1812,14,13,5,11,'_order','1001'),
	(1811,14,13,5,11,'_id','14'),
	(1810,14,13,5,11,'bio_processed','<p>Drew McLellan joined edgeofmyseat.com as a Director and web developer in September 2007. He’s the lead developer on Perch.</p>'),
	(1809,14,13,5,11,'bio_raw','Drew McLellan joined edgeofmyseat.com as a Director and web developer in September 2007. He’s the lead developer on Perch.'),
	(1808,14,13,5,11,'bio','<p>Drew McLellan joined edgeofmyseat.com as a Director and web developer in September 2007. He’s the lead developer on Perch.</p>'),
	(1807,14,13,5,11,'image_h','400'),
	(1806,14,13,5,11,'image_w','400'),
	(1805,14,13,5,11,'image_bucket','default'),
	(1804,14,13,5,11,'image_size','14768'),
	(1803,14,13,5,11,'image_path','bird-2.jpg'),
	(1802,14,13,5,11,'image__default','/perch/resources/bird-2.jpg'),
	(1801,14,13,5,11,'image','/perch/resources/bird-2.jpg'),
	(1800,14,13,5,11,'role','Company Director'),
	(1799,14,13,5,11,'familyname','McLellan'),
	(1798,14,13,5,11,'givenname','Drew'),
	(1797,13,13,5,11,'_order','1000'),
	(1796,13,13,5,11,'_id','13'),
	(1795,13,13,5,11,'bio_processed','<p>Rachel Andrew founded edgeofmyseat.com in September 2001 and is an experienced front and back-end web developer.</p>'),
	(1794,13,13,5,11,'bio_raw','Rachel Andrew founded edgeofmyseat.com in September 2001 and is an experienced front and back-end web developer.'),
	(1793,13,13,5,11,'bio','<p>Rachel Andrew founded edgeofmyseat.com in September 2001 and is an experienced front and back-end web developer.</p>'),
	(1792,13,13,5,11,'image_h','400'),
	(1791,13,13,5,11,'image_w','400'),
	(1790,13,13,5,11,'image_bucket','default'),
	(1789,13,13,5,11,'image_size','16138'),
	(1788,13,13,5,11,'image_path','bird-1.jpg'),
	(1787,13,13,5,11,'image__default','/perch/resources/bird-1.jpg'),
	(1786,13,13,5,11,'image','/perch/resources/bird-1.jpg'),
	(1785,13,13,5,11,'role','Company Director & Founder'),
	(1784,13,13,5,11,'familyname','Andrew'),
	(1783,13,13,5,11,'givenname','Rachel'),
	(1745,23,18,7,2,'_order','1000'),
	(1744,23,18,7,2,'_id','23'),
	(1743,23,18,7,2,'body_processed','<p>Read the latest news and relocation tips from Swift Migrations.</p>'),
	(1742,23,18,7,2,'body_raw','Read the latest news and relocation tips from Swift Migrations.'),
	(1741,23,18,7,2,'body','<p>Read the latest news and relocation tips from Swift Migrations.</p>'),
	(1740,23,18,7,2,'heading','Our Blog'),
	(1751,24,19,8,2,'_order','1000'),
	(1750,24,19,8,2,'_id','24'),
	(1749,24,19,8,2,'body_processed','<p>We were founded in the year 2009 after an accident involving a walrus.</p>'),
	(1748,24,19,8,2,'body_raw','We were founded in the year 2009 after an accident involving a walrus.'),
	(1747,24,19,8,2,'body','<p>We were founded in the year 2009 after an accident involving a walrus.</p>'),
	(1746,24,19,8,2,'heading','Did you know?'),
	(1757,25,20,9,2,'_order','1000'),
	(1756,25,20,9,2,'_id','25'),
	(1755,25,20,9,2,'body_processed','<p>All of the posts can be found here.</p>'),
	(1754,25,20,9,2,'body_raw','All of the posts can be found here.'),
	(1753,25,20,9,2,'body','<p>All of the posts can be found here.</p>'),
	(1752,25,20,9,2,'heading','Blog Archive'),
	(1867,4,4,1,5,'heading','More than you might think');
...
INSERT INTO `perch2_content_resources` VALUES (89,1),
	(89,2),
	(89,3),
	(90,4),
	(90,5),
...
INSERT INTO `perch2_page_templates` VALUES (1,'About','about.php',2,1,''),
	(2,'Default','default.php',0,1,'');
...
INSERT INTO `perch2_pages` VALUES (1,0,'/index.php','Home page','Home page',0,1,1,'','000-001','','',0,0,'',0,'2014-01-01 00:00:00','','default.html'),
	(2,0,'/about/index.php','About','About',0,2,1,'/about','000-002','','',0,0,'',0,'2014-01-01 00:00:00','','default.html'),
	(3,2,'/about/history.php','History','History',0,1,2,'/about/history','000-002-001','','',0,0,'',0,'2014-01-01 00:00:00','','default.html'),
	(4,0,'/contact.php','Contact','Contact',0,3,1,'/contact','000-003','','',0,0,'',0,'2014-01-01 00:00:00','','default.html'),
	(5,0,'/team.php','Team','Team',0,4,1,'/team','000-004','','',0,0,'',0,'2014-01-01 00:00:00','','default.html'),
	(6,0,'/testimonials.php','Testimonials','Testimonials',0,5,1,'/testimonials','000-005','','',0,0,'',0,'2014-01-01 00:00:00','','default.html'),
	(7,0,'/blog/index.php','Blog','Blog',0,6,1,'/blog','000-006','','',0,0,'',0,'2014-01-01 00:00:00','','default.html'),
	(8,7,'/blog/post.php','Post','Post',0,1,2,'/blog/post','000-006-001','','',0,0,'',0,'2014-01-01 00:00:00','','default.html'),
	(9,7,'/blog/archive.php','Archive','Archive',0,2,2,'/blog/archive','000-006-002','','',0,0,'',0,'2014-01-01 00:00:00','','default.html');
...
INSERT INTO `perch2_resources` VALUES (1,'content','default','nesting-bird.jpg','orig',0,'jpg'),
	(2,'content','default','nesting-bird-thumb.jpg','thumb',1,'jpg'),
	(3,'content','default','nesting-bird-w520h520.jpg','',1,'jpg'),
	(4,'content','default','sunset-birds.jpg','orig',0,'jpg'),
	(5,'content','default','sunset-birds-thumb.jpg','thumb',4,'jpg'),
	(6,'content','default','sunset-birds-w520h520.jpg','',4,'jpg'),
	(7,'content','default','birdhouse.jpg','orig',0,'jpg'),
	(8,'content','default','birdhouse-thumb.jpg','thumb',7,'jpg'),
	(9,'content','default','birdhouse-w520h520.jpg','',7,'jpg'),
	(10,'content','default','bird-1.jpg','orig',0,'jpg'),
	(11,'content','default','bird-1-thumb.jpg','thumb',10,'jpg'),
	(12,'content','default','bird-1-w400h400.jpg','',10,'jpg'),
	(13,'content','default','bird-2.jpg','orig',0,'jpg'),
	(14,'content','default','bird-2-thumb.jpg','thumb',13,'jpg'),
	(15,'content','default','bird-2-w400h400.jpg','',13,'jpg'),
	(16,'content','default','bird-4.jpg','orig',0,'jpg'),
	(17,'content','default','bird-4-thumb.jpg','thumb',16,'jpg'),
	(18,'content','default','bird-4-w400h400.jpg','',16,'jpg'),
	(19,'content','default','bird-3.jpg','orig',0,'jpg'),
	(20,'content','default','bird-3-thumb.jpg','thumb',19,'jpg'),
	(21,'content','default','bird-3-w400h400.jpg','',19,'jpg');
...
INSERT INTO `perch2_settings` VALUES ('headerColour',0,'#ffffff'),
	...
	('helpURL',0,'http://docs.grabaperch.com/demo/swift'),
	('siteURL',0,'/'),
	('hideBranding',0,'0'),
...
INSERT INTO `perch2_user_privileges` VALUES (1,'perch.login','Log in',1),
	...
	(16,'perch_forms','Access forms',1),
	(17,'perch_forms.configure','Configure forms',1),
	(18,'perch_forms.delete','Delete forms',1),
	(19,'perch_blog','Access the blog',1),
	(20,'perch_blog.post.create','Create posts',1),
	(21,'perch_blog.post.delete','Delete posts',1),
	(22,'perch_blog.post.publish','Publish posts',1),
	(23,'perch_blog.comments.moderate','Moderate comments',1),
	(24,'perch_blog.comments.enable','Enable comments on a post',1),
	(25,'perch_blog.categories.manage','Manage categories',1),
	(26,'perch_blog.import','Import data',1),
	(27,'perch_blog.authors.manage','Manage authors',1),
	(28,'content.pages.republish','Republish pages',12),
	(29,'content.pages.create.toplevel','Add new top-level pages',3),
	(30,'content.pages.delete.own','Delete pages they created themselves',4),
	(31,'content.templates.configure','Configure master pages',6),
	(32,'content.pages.attributes','Edit page titles and attributes',6);
...
INSERT INTO `perch2_users` VALUES (1,'{username}','{password}','2013-05-02 12:55:56','2014-02-12 12:53:07','2014-02-12 12:51:58','{firstname}','{lastname}','{email}',1,'e9e590fed1232a159bb1cc0984cdac70',2,1);
...
-- Dump completed on 2014-02-12 14:29:27